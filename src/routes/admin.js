...
module.exports = function (app, name, middleware, controllers) {
	...
	helpers.setupAdminPageRoute(app, `/${name}/manage/leaderboard`, middlewares, controllers.admin.categories.getLeaderboardPage);
	...
	helpers.setupAdminPageRoute(app, `/${name}/manage/categories/:category_id/leaderboard`, middlewares, controllers.admin.categories.getLeaderboard);
